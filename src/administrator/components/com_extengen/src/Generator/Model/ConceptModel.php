...
/**
 * One modelled language: a projectForm, in LionCore M3.
 *
...
final class ConceptModel implements ModelInterface
{
    ...
    /**
     * @param  object  $data  The projectForm as stored, decoded.
     *
     * @since  1.2.0
     */
    ...
    /**
     * Read a projectForm from the JSON the component stores in `form_data`.
     *
    ...
    public static function fromJson(string $json): self
    {
        ...
        if (!\is_object($decoded)) {
            throw new \InvalidArgumentException(
                'A projectForm must be a JSON object, got ' . get_debug_type($decoded) . '.'
            );
        }
    ...
    /**
     * Read a projectForm from an already decoded value.
     *
     * @since  1.2.0
     */
