...
namespace Yepr\Component\Extengen\Administrator\Generator\Meta;

use DOMDocument;
use DOMElement;
use Yepr\Component\Extengen\Administrator\Generator\Model\Classifier;
use Yepr\Component\Extengen\Administrator\Generator\Model\Feature;
...
final class FormXml
{
     ...
     * @since  1.2.0
     */
    public const FORM_ROOT = 'administrator/components/com_extengen/forms/projectForms/';

    /**
     * The prefix the generated forms register for custom field types and rules.
     *
     * Generated forms use `type="Reference"`, which is this component's own
     * field class - the same one the hand-written forms use since 1.9. A
     * modelled language does not get to name a field class of its own: that is
     * one of the three model gaps 4.2 names, and it blocks self-hosting rather
     * than this step.
     *
     * @since  1.2.0
     */
    public const FIELD_PREFIX = 'Yepr\\Component\\Extengen\\Administrator\\Field';
     ...
     * @since  1.2.0
     */
    public const RULE_PREFIX = 'Yepr\\Component\\Extengen\\Administrator\\Rule';
    ...
    {
        $constant = 'COM_EXTENGEN_' . strtoupper(implode('_', $parts));
