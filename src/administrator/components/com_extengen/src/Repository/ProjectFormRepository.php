...
/**
 * Loads a stored project form: a model of the model language, in LionWeb terms.
 *
 ...
 * @since  0.9.0
 */
final class ProjectFormRepository
{
    /**
    ...
    public function findRaw(int $id): ?object
    {
        ...
        $query = $this->db->getQuery(true)
            ...
            ->from($this->db->quoteName('#__extengen_projectforms'))
