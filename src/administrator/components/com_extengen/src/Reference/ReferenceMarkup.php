 ...
 * the agreement between the server and `admin-extengen-reference.js`. Keeping
 * it here means the agreement can be tested, which it could not be inside a
 * `FormField`: the suite has no Joomla, on purpose.
 *
...
final class ReferenceMarkup
{
    ...
    public function render(
        ...
        return '<extengen-reference' . $attributes . '>'
