...
/**
	...
	public function batch($model = null)
	{
		...
		$model = $this->getModel('Participant', 'Administrator', []);

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_conference&view=participants' . $this->getRedirectToListAppend(), false));
