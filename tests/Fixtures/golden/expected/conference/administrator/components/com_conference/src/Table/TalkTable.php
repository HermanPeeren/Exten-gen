 ...
 * Talk Table class.
 */
class TalkTable extends Table implements TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_conference.talk';

		parent::__construct('#__conference_talk', 'id', $db);
	}
...
/*
	...
	/**
	 * Method to delete a talk (and mappings of that talk to related entities) from the database.
	 *
	 * @param   integer  $talkId  An optional talk id.
	 *
	 * @return  boolean  True on success, false on failure.
	 *
	 * @see     \Joomla\CMS\Table\User handling of user groups
	 */
	public function delete($talkId = null):bool
	{
		$db    = $this->getDatabase();
