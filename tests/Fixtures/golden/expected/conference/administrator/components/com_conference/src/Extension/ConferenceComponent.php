...
namespace Yepr\Component\Conference\Administrator\Extension;

defined('_JEXEC') or die;

// todo: (optionally) add Html-services for this component
//use Yepr\Component\Conference\Administrator\Service\Html\Conference;
//use Yepr\Component\Conference\Administrator\Service\Html\AdministratorService;
//use Yepr\Component\Conference\Administrator\Service\Html\Icon;
...
/**
 * Component class for com_conference
 ...
 */
class ConferenceComponent extends MVCComponent implements
	BootableExtensionInterface, CategoryServiceInterface, TagServiceInterface, RouterServiceInterface
{
	...
	public function boot(ContainerInterface $container)
	{
		...
		//$this->getRegistry()->register('conferenceadministrator', new AdministratorService());
		// todo: shouldn't that be an icon per entity or per page/view?
		//$this->getRegistry()->register('conferenceicon', new Icon($container->get(SiteApplication::class)));
	}
	...
	{
		// todo: this conference_details is probably wrong: should be some entity?
		return ($section === 'category' ? 'categories' : 'conference_details');
	}
