...
/** @var \Yepr\Component\Conference\Administrator\View\Talks\HtmlView $this */
...
if ($saveOrder && !empty($this->items)) {
	$saveOrderingUrl = 'index.php?option=com_conference&task=talks.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
}
?>
<form action="<?php echo Route::_('index.php?option=com_conference&view=talks'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
				...
				<?php else : ?>
                    <table class="table" id="talksList">
                        <caption class="visually-hidden">
							<?php echo Text::_('COM_CONFERENCE_TALKS_TABLE_CAPTION'); ?>, <?php echo Text::_('JGLOBAL_SORTED_BY'); ?>
                        </caption>
                        <thead>
                        <tr>
					...
					<?php /*echo HTMLHelper::_(
						...
						'collapseModal',
						[
							'title'  => Text::_('COM_CONFERENCE_BATCH_OPTIONS_TALKS'),
