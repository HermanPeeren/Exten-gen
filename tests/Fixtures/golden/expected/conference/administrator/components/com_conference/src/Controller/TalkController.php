 ...
 * @version 1.0.0
 */
class TalkController extends FormController
{
	/**
...
/**
	...
	public function batch($model = null)
	{
		...
		$model = $this->getModel('Talk', 'Administrator', []);

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_conference&view=talks' . $this->getRedirectToListAppend(), false));
