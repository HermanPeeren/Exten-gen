 ...
 * @version 1.0.0
 */
class SessionController extends FormController
{
	/**
...
/**
	...
	public function batch($model = null)
	{
		...
		$model = $this->getModel('Session', 'Administrator', []);

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_conference&view=program' . $this->getRedirectToListAppend(), false));
