...
/** @var \Yepr\Component\Conference\Administrator\View\Rooms\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_conference&view=rooms'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
				...
				<?php else : ?>
                    <table class="table" id="roomsList">
                        <caption class="visually-hidden">
							<?php echo Text::_('COM_CONFERENCE_ROOMS_TABLE_CAPTION'); ?>, <?php echo Text::_('JGLOBAL_SORTED_BY'); ?>
                        </caption>
                        <thead>
                        <tr>
					...
					<?php /*echo HTMLHelper::_(
						...
						'collapseModal',
						[
							'title'  => Text::_('COM_CONFERENCE_BATCH_OPTIONS_ROOMS'),
