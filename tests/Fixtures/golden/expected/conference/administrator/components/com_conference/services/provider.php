...
use Yepr\Component\Conference\Administrator\Extension\ConferenceComponent;
//use Yepr\Component\Conference\Administrator\Helper\AssociationsHelper;//...
...
return new class implements ServiceProviderInterface {
	...
	public function register(Container $container)
	{
		...
		$componentNamespace = 'Yepr\\Component\\Conference';
		...
		$container->set(
			...
			function (Container $container) {
				$component = new ConferenceComponent($container->get(ComponentDispatcherFactoryInterface::class));
