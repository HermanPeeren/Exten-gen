...
namespace Yepr\Component\Conference\Administrator\View\Talk;
...
use Yepr\Component\Conference\Administrator\Model\TalkModel;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title($isNew ? Text::_('COM_CONFERENCE_MANAGER_TALK_NEW') : Text::_('COM_CONFERENCE_MANAGER_TALK_EDIT'), 'address talk');
		...
		if ($isNew) {
			...
			if ($isNew) {
				ToolbarHelper::apply('talk.apply');
				ToolbarHelper::saveGroup(
					[
						['save', 'talk.save'],
						['save2new', 'talk.save2new']
					],
					'btn-success'
				);
			}

			ToolbarHelper::cancel('talk.cancel');
		} else {
			...
			//if ($itemEditable) {
				ToolbarHelper::apply('talk.apply');
				$toolbarButtons[] = ['save', 'talk.save'];

				// We can save this record, but check the create permission to see if we can return to make a new one.
				//if ($canDo->get('core.create')) {
					$toolbarButtons[] = ['save2new', 'talk.save2new'];
				//}
			//}

			// If checked out, we can still save
			//if ($canDo->get('core.create')) {
				$toolbarButtons[] = ['save2copy', 'talk.save2copy'];
			//}
			...
			if (Associations::isEnabled() && ComponentHelper::isEnabled('com_associations')) {
				ToolbarHelper::custom('talk.editAssociations', 'contract', 'contract', 'JTOOLBAR_ASSOCIATIONS', false, false);
			}

			ToolbarHelper::cancel('talk.cancel', 'JTOOLBAR_CLOSE');
		}
