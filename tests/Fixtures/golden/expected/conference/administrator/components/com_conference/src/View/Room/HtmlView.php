...
namespace Yepr\Component\Conference\Administrator\View\Room;
...
use Yepr\Component\Conference\Administrator\Model\RoomModel;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title($isNew ? Text::_('COM_CONFERENCE_MANAGER_ROOM_NEW') : Text::_('COM_CONFERENCE_MANAGER_ROOM_EDIT'), 'address room');
		...
		if ($isNew) {
			...
			if (Associations::isEnabled() && ComponentHelper::isEnabled('com_associations')) {
				ToolbarHelper::custom('room.editAssociations', 'contract', 'contract', 'JTOOLBAR_ASSOCIATIONS', false, false);
			}
