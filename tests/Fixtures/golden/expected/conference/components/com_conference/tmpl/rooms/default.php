            ...
            <div id="j-main-container" class="j-main-container">
                ...
                <table class="table table-striped" id="roomsList">
                    ...
                    <tr>
                                            ...
                                            <th scope="col">
                            <?php echo Text::_('COM_CONFERENCE_TABLE_ROOM_TABLEHEAD_ROOM_NAME'); ?>
                        </th>
                                            <th scope="col">
                            <?php echo Text::_('COM_CONFERENCE_TABLE_ROOM_TABLEHEAD_POSITION'); ?>
                        </th>
                    ...
                    <tr class="row<?php echo $i % 2; ?>" data-draggable-group='1' data-transition>
                                    ...
                                    echo Route::_('index.php?option=com_conference&view=room&id=' . (int) $item->id); ?>"
