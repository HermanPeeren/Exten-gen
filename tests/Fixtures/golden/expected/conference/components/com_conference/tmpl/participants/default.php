            ...
            <div id="j-main-container" class="j-main-container">
                ...
                <table class="table table-striped" id="participantsList">
                    ...
                    <tr>
                                            ...
                                            <th scope="col">
                            <?php echo Text::_('COM_CONFERENCE_TABLE_SPEAKER_TABLEHEAD_NAME'); ?>
                        </th>
                                            <th scope="col">
                            <?php echo Text::_('COM_CONFERENCE_TABLE_SPEAKER_TABLEHEAD_ORGANISATION'); ?>
                        </th>
                                            <th scope="col">
                            <?php echo Text::_('COM_CONFERENCE_TABLE_SPEAKER_TABLEHEAD_NATIONALITY'); ?>
                        </th>
                                            <th scope="col">
                            <?php echo Text::_('COM_CONFERENCE_TABLE_SPEAKER_TABLEHEAD_ADDRESS'); ?>
                        </th>
                    ...
                    <tr class="row<?php echo $i % 2; ?>" data-draggable-group='1' data-transition>
                                    ...
                                    echo Route::_('index.php?option=com_conference&view=participant&id=' . (int) $item->id); ?>"
