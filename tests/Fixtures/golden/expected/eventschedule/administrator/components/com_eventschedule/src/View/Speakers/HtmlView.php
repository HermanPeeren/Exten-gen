...
namespace Yepr\Component\eventschedule\Administrator\View\Speakers;
...
use Yepr\Component\eventschedule\Administrator\Model\SpeakersModel;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_EVENTSCHEDULE_MANAGER_SPEAKERS'), 'address speakers');
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			$childBar->standardButton('featured')
				->text('JFEATURE')
				->task('speakers.featured')
				->listCheck(true);
			$childBar->standardButton('unfeatured')
				->text('JUNFEATURE')
				->task('speakers.unfeatured')
				->listCheck(true);
