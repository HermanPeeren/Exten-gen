...
/**
 * DaySchedule controller class.
 *
 * @version 1.0.1
 */
class DayScheduleController extends FormController
{
	/**
...
/**
	...
	public function batch($model = null)
	{
		...
		$model = $this->getModel('DaySchedule', 'Administrator', []);

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_eventschedule&view=dayschedules' . $this->getRedirectToListAppend(), false));
