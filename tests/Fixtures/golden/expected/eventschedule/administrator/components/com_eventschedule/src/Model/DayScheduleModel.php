...
class DayScheduleModel extends AdminModel
{
	...
	protected function loadFormData()
	{
		...
		if (empty($data))
		{
			...
			{
				$data->set('catid', $app->getInput()->get('catid', $app->getUserState('com_eventschedule.dayschedule.filter.category_id'), 'int')); // todo: for categories the plural entityname or pagename (?) is used; 'foos' in examples
			}*/
		}
