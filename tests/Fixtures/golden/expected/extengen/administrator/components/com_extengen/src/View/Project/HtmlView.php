...
use Yepr\Component\Extengen\Administrator\Model\ProjectModel;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title($isNew ? Text::_('COM_EXTENGEN_MANAGER_PROJECT_NEW') : Text::_('COM_EXTENGEN_MANAGER_PROJECT_EDIT'), 'address project');
