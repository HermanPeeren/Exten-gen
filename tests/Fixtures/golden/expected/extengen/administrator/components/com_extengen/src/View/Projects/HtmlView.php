...
use Yepr\Component\Extengen\Administrator\Model\ProjectsModel;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_EXTENGEN_MANAGER_PROJECTS'), 'address projects');
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			$childBar->standardButton('featured')
				->text('JFEATURE')
				->task('projects.featured')
				->listCheck(true);
			$childBar->standardButton('unfeatured')
				->text('JUNFEATURE')
				->task('projects.unfeatured')
				->listCheck(true);
			...
			{
				$childBar->delete('projects.delete')
