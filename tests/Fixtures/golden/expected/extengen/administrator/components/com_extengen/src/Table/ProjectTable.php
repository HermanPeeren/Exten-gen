 ...
 * Project Table class.
 */
class ProjectTable extends Table implements TaggableTableInterface
{
	...
	public function __construct(DatabaseDriver $db)
	{
		...
		parent::__construct('#__extengen_project', 'id', $db);
	}
...
/*
	...
	/**
	 * Method to delete a project (and mappings of that project to related entities) from the database.
	 *
	 * @param   integer  $projectId  An optional project id.
	 *
	 * @return  boolean  True on success, false on failure.
	 *
	 * @see     \Joomla\CMS\Table\User handling of user groups
	 */
	public function delete($projectId = null):bool
	{
		$db    = $this->getDatabase();
