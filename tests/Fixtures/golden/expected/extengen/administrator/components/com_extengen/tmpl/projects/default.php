...
/** @var \Yepr\Component\Extengen\Administrator\View\Projects\HtmlView $this */
            ...
            <div id="j-main-container" class="j-main-container">
				...
				<?php else : ?>
                    <table class="table" id="projectsList">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="width:1%" class="text-center d-none d-md-table-cell">
		                        ...
		                        'COM_EXTENGEN_TABLE_PROJECT_TABLEHEAD_NAME', $listDirn, $listOrder);
                                ?>
                            </th>
                            <th scope="col" style="width:1%" class="text-center d-none d-md-table-cell">
		                        <?php echo HTMLHelper::_('searchtools.sort',
		                        'COM_EXTENGEN_TABLE_PROJECT_TABLEHEAD_FORM_DATA', $listDirn, $listOrder);
                                ?>
                            </th>
                            <th scope="col" style="width:1%" class="text-center d-none d-md-table-cell">
		                        <?php echo HTMLHelper::_('searchtools.sort',
		                        'COM_EXTENGEN_TABLE_PROJECT_TABLEHEAD_METALANGUAGE_KEY', $listDirn, $listOrder);
                                ?>
                            </th>
                            <th scope="col" style="width:1%" class="text-center d-none d-md-table-cell">
		                        <?php echo HTMLHelper::_('searchtools.sort',
                            ...
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <a class="hasTooltip" href="<?php
                                 ...
                                 <td class="text-center d-none d-md-table-cell">
	                                <?php echo $item->form_data; ?>
                                </td>
                                 <td class="text-center d-none d-md-table-cell">
	                                <?php echo $item->metalanguage_key; ?>
                                </td>
                                 <td class="text-center d-none d-md-table-cell">
					...
					<?php /*echo HTMLHelper::_(
						...
						'collapseModal',
						[
							'title'  => Text::_('COM_EXTENGEN_BATCH_OPTIONS_PROJECTS'),
