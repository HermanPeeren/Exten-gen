...
//use Yepr\Component\Extengen\Administrator\Service\Html\Extengen;
	...
	BootableExtensionInterface, CategoryServiceInterface, TagServiceInterface, RouterServiceInterface
{
	...
	{
		// todo: this extengen_details is probably wrong: should be some entity?
		return ($section === 'category' ? 'categories' : 'extengen_details');
	}
