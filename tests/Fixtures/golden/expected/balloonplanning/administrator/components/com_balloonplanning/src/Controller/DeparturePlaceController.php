...
/**
 * DeparturePlace controller class.
 *
 * @version 6.0.0 alpha
 */
class DeparturePlaceController extends FormController
{
	/**
	...
	{
		$this->view_list = 'departureplaces';
...
/**
	...
	public function batch($model = null)
	{
		...
		$model = $this->getModel('DeparturePlace', 'Administrator', []);

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_balloonplanning&view=departureplaces' . $this->getRedirectToListAppend(), false));
