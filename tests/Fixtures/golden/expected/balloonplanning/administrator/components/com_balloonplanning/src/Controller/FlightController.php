 ...
 * @version 6.0.0 alpha
 */
class FlightController extends FormController
{
	/**
...
/**
	...
	public function batch($model = null)
	{
		...
		$model = $this->getModel('Flight', 'Administrator', []);

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_balloonplanning&view=flights' . $this->getRedirectToListAppend(), false));
