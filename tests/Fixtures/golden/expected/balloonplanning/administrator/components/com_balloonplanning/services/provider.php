...
use Yepr\Component\BalloonPlanning\Administrator\Extension\BalloonPlanningComponent;
//use Yepr\Component\BalloonPlanning\Administrator\Helper\AssociationsHelper;//...
...
return new class implements ServiceProviderInterface {
	...
	public function register(Container $container)
	{
		...
		$componentNamespace = 'Yepr\\Component\\BalloonPlanning';
		...
		$container->set(
			...
			function (Container $container) {
				$component = new BalloonPlanningComponent($container->get(ComponentDispatcherFactoryInterface::class));
