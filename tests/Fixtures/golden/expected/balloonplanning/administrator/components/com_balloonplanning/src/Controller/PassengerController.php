 ...
 * @version 6.0.0 alpha
 */
class PassengerController extends FormController
{
	/**
...
/**
	...
	public function batch($model = null)
	{
		...
		$model = $this->getModel('Passenger', 'Administrator', []);

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_balloonplanning&view=ticket' . $this->getRedirectToListAppend(), false));
