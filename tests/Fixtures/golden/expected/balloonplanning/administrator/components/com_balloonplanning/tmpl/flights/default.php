...
/** @var \Yepr\Component\BalloonPlanning\Administrator\View\Flights\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_balloonplanning&view=flights'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
				...
				<?php else : ?>
					...
					<?php /*echo HTMLHelper::_(
						...
						'collapseModal',
						[
							'title'  => Text::_('COM_BALLOONPLANNING_BATCH_OPTIONS_FLIGHTS'),
