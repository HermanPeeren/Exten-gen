...
namespace Yepr\Component\BalloonPlanning\Administrator\Extension;

defined('_JEXEC') or die;

// todo: (optionally) add Html-services for this component
//use Yepr\Component\BalloonPlanning\Administrator\Service\Html\BalloonPlanning;
//use Yepr\Component\BalloonPlanning\Administrator\Service\Html\AdministratorService;
//use Yepr\Component\BalloonPlanning\Administrator\Service\Html\Icon;
...
/**
 * Component class for com_balloonplanning
 ...
 */
class BalloonPlanningComponent extends MVCComponent implements
	BootableExtensionInterface, CategoryServiceInterface, TagServiceInterface, RouterServiceInterface
{
	...
	{
		// todo: this balloonplanning_details is probably wrong: should be some entity?
		return ($section === 'category' ? 'categories' : 'balloonplanning_details');
	}
