...
/**
 * Methods supporting a list of Balloons records.
 */
class BalloonsModel extends ListModel
{
    /**
	 * Constructor.
	 *
	...
	protected function getListQuery():QueryInterface
	{
		...
		$query->select([
			$db->quoteName('balloon.call-sign'),
			$db->quoteName('balloon.capacity'),
			$db->quoteName('balloon.license'),
			$db->quoteName('balloon.planning_color'),
			$db->quoteName('balloon.id')
		]);
