 ...
 */
class ReservationTable extends Table implements TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_balloonplanning.reservation';

		parent::__construct('#__balloonplanning_reservation', 'id', $db);
	}
...
/*
	...
	/**
	 * Method to delete a reservation (and mappings of that reservation to related entities) from the database.
	 *
	 * @param   integer  $reservationId  An optional reservation id.
	 *
	 * @return  boolean  True on success, false on failure.
	 *
	 * @see     \Joomla\CMS\Table\User handling of user groups
	 */
	public function delete($reservationId = null):bool
	{
		$db    = $this->getDatabase();
