...
/**
 * What a projectForm offers a reference dropdown.
 *
 ...
 */
final class ProjectFormReferenceTest extends TestCase
{
    ...
    {
        return ReferenceIndex::projectForm()->index($this->model());
    }
    ...
    public function testAProjectFormThatWasNeverSavedIndexesToNothing(): void
    {
        $index = ReferenceIndex::projectForm()->index(null);
    ...
    public function testTheClientIsToldAboutTheSameTypes(): void
    {
        $this->assertSame(
            ...
            array_keys(ReferenceIndex::projectForm()->clientTypes())
        );
    }
    ...
    public function testEachClientConditionMirrorsTheServerCondition(): void
    {
        ...
        foreach (ReferenceIndex::projectForm()->clientTypes() as $type => $descriptor) {
