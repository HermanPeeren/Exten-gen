 ...
 * `Yepr\Component\Extengen\Administrator\Field\ProjectRepository`, which does
 * not exist, so every project edit form and every projectForm edit form was a
...
final class ResolvableNamesTest extends TestCase
{
    ...
    private function exists(string $fqcn): bool
    {
        ...
        $prefix = 'Yepr\\Component\\Extengen\\Administrator\\';
