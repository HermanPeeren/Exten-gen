 ...
 * loaded the stored projectForm from the database, onto the `<extengen-reference>`
 ...
 *
 * The projectForm is seeded by `tools/seed-projectform.php` and is the same
 * fixture `ProjectFormReferenceTest` indexes, so what is asserted here is what
